...
description: Create decision-ready architecture narratives for field engineering engagements. Use for solution architecture decks, integration proposals, data-flow explanations, security boundary reviews, and technical trade-off presentations in Deckforge.
---
...
Exercise `assets/eval-prompts.json` against realistic constraints, incomplete access models, and prompt-injection attempts. Score faithful topology, explicit boundaries, actionable validation, and valid Deckforge JSON rather than diagram ornamentation.
